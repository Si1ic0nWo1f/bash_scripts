...
If only scanning your local broadcast domain, add the one liner from https://github.com/SiliconW01f/bash_scripts/blob/master/local_arp_scan.sh before line 35
